package com.naver.login.google;
...
public class GoogleController {
	...
	public String GetRequestToken(HttpServletRequest request) throws JsonParseException, JsonMappingException, IOException {
        ...
        parameters.add("client_id", "504055526892-0mmnnv34n2935mnc7u1jk7ukav085r91.apps.googleusercontent.com");
        parameters.add("client_secret", "Bq6CJAzyM_CSLCFzhPysBDvL");
